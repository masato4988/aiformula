...
private:
    ...
    rclcpp::Subscription<nav_msgs::msg::Path>::SharedPtr first_path_subscriber_;
    rclcpp::Subscription<nav_msgs::msg::Path>::SharedPtr second_path_subscriber_;
    ...
    void firstPathCallback(const nav_msgs::msg::Path::SharedPtr msg) {
        first_point_ = msg->poses;
    }
    void secondPathCallback(const nav_msgs::msg::Path::SharedPtr msg) {
        second_point_ = msg->poses;
    }
